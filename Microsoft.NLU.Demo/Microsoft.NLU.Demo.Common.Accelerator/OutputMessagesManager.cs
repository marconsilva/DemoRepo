...
using Microsoft.NLU.Demo.Common.Accelerator.ServiceModels;
using Microsoft.Cognitive.LUIS;

namespace Microsoft.NLU.Demo.Common.Accelerator
{
    public sealed class OutputMessagesManager
    {
        ...
        public string GetForecastMaxTemperatureMessage(float maxTemperature)
        {
            switch (language)
            {
                ...
                case OutputMessagesManagerLanguage.pt_PT:
                default:
                    return $"A temperatura máxima é de {maxTemperature:0.##} graus";
            }
        }
